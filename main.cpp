...
int main(int argc,char* argv[]) {
    ...
    if (argc >= 2 && strcmp(argv[1], "test") == 0) {
        ...
        if (strcmp(argv[1], "mjai_log") == 0) {
            std::cout << "calculating best_moves" << std::endl;
            auto best_moves = mjai_interface.get_best_move(id, true);
        ...
        std::string dir_name = argc >= 3 ? argv[2] : "";
        std::string player_name_prefix = argc >= 4 ? argv[3] : "Kanon";
        ...
        while(1) {
            ...
            if (type == "hello") {
                ...
                best_moves = mjai_interface.get_best_move(id, true);
