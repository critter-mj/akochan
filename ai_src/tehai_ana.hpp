...
class Tehai_Pattern_Source {
public:
	Tehai_Pattern_Source();
	void reset();
	std::vector<int> mentu_hai;
	std::vector<int> head_hai;
	std::vector<int> tatu_hai;
	std::vector<int> koritu1_hai;
	std::vector<int> koritu2_hai;
};
...
class Tehai_Analyzer : public Tehai_Analyzer_Basic {
public:
	Tehai_Analyzer();
