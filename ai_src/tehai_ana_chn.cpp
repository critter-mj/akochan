...
void Tehai_Analyzer_Basic_Chn::reset_tehai_analyzer_basic_with(const Hai_Array& tehai_src, const bool reach_flag, const Fuuro_Vector& fuuro){
	reset_tehai_analyzer_basic();
	set_tehai_num(0);
...
void Tehai_Analyzer_Chn::reset_tehai_analyzer_with(const Hai_Array& tehai_src, const bool reach_flag, const Fuuro_Vector& fuuro){
